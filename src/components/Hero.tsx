...
const Hero = () => {
  ...
  return <section id="home" className="relative min-h-screen flex items-center justify-center px-4 pt-20">
      <div className="max-w-5xl mx-auto text-center">
        ...
        {/* Main Heading */}
        <motion.h1 className="font-display text-5xl md:text-7xl lg:text-8xl font-bold leading-tight mb-6" initial={{
        opacity: 0,
        y: 30
      }} animate={{
        opacity: 1,
        ...
        delay: 0.3
          ...
          <span className="relative">
            ...
            <motion.svg className="absolute -bottom-2 left-0 w-full" viewBox="0 0 300 20" initial={{
            pathLength: 0
          }} animate={{
            pathLength: 1
          }} transition={{
            ...
            duration: 0.8
              ...
              <motion.path d="M 0 15 Q 150 0 300 15" fill="none" stroke="hsl(174 72% 50%)" strokeWidth="3" strokeLinecap="round" />
            </motion.svg>
          </span>
        </motion.h1>

        {/* Subheading */}
        <motion.p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10" initial={{
        opacity: 0,
        y: 20
      }} animate={{
        opacity: 1,
        ...
        delay: 0.5
          ...
          {features.map((feature, index) => <motion.div key={feature.text} className="flex items-center gap-2 text-sm text-muted-foreground" initial={{
          opacity: 0,
          x: -20
        }} animate={{
          opacity: 1,
        ...
        delay: 1
          ...
          <motion.a href="#analyze" className="flex flex-col items-center gap-2 text-muted-foreground hover:text-primary transition-colors" animate={{
          y: [0, 8, 0]
        }} transition={{
          duration: 2,
          repeat: Infinity
