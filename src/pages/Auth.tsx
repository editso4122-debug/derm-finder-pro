      ...
      >
        ...
        <div className="bg-secondary/50 backdrop-blur-lg rounded-2xl p-8 border border-primary/20 shadow-xl">
          ...
          <Button
            ...
            className="w-full mb-6 bg-background/50 border-primary/30 hover:bg-background hover:border-primary text-foreground"
          >
            {isGoogleLoading ? (
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-secondary/50 text-muted-foreground">or continue with email</span>
            </div>
          </div>
